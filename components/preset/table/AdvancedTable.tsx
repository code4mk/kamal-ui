...
const UserTable: React.FC = () => {
  ...
  const filteredAndSortedUsers = useFilterSort<User>(
    users,
    searchQuery,
    sortConfig,
    {
      // Optional: specify specific fields to search
      searchFields: ['name', 'email', 'role', 'status', 'address.city', 'address.country', 'company.name']
    }
  );
